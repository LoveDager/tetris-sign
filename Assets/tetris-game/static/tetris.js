...
//(function(window, document, undefined) {
    ...
    var canvas = document.getElementById('game'),
        ...
        bevel_size = 0; //Math.floor(block_size / 10),
        border_width = 0;
    ...
    var shapeFactory = {
        line: function() {
            ...
            hor = [-1, -2, 0, -2, 1, -2, 2, -2];
            return new Shape([ver, hor, ver, hor], '#0ad2ff', true);
        },
        square: function() {
            /*
             *  XX
            ...
            return new Shape([s, s, s, s], '#2962ff', true);
        },
        arrow: function() {
            /*
             *    X   X       X
        ...
        leftZag: function() {
            ...
            var ver = [0, 0, 0, -1, 1, -1, 1, -2],
                hor = [0, -1, 1, -1, 1, 0, 2, 0];
            return new Shape([hor, ver, hor, ver], '#b4e600', true);
        },
        rightZag: function() {
            /*
             *       X
            ...
            var ver = [0, -2, 0, -1, 1, -1, 1, 0],
                hor = [0, 0, 1, 0, 1, -1, 2, -1];
            return new Shape([hor, ver, hor, ver], '#0fffdb', true);
        }
    ...
    var board = {
        ...
        animate: function() {
            ...
            if (!gameOver)
                DownloadCanvasAsImage(board.framenumberforsave++);
